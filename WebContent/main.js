...
function openSocket() {
    ...
    webSocket.onclose = function(event) {
        alert('Error! Conección cerrada. Intenta conectarte de nuevo.');
    };
}
...
function parseMessage(message) {
    ...
    if (jObj.flag == 'self') {
        ...
        $('p.online_count').html(
                'Hola, <span class="green">' + name + '</span>. <b>'
                        + online_count + '</b> persona/s en linea ahora')
                .fadeIn();
